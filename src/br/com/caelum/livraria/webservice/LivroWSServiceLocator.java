...
public class LivroWSServiceLocator extends org.apache.axis.client.Service implements br.com.caelum.livraria.webservice.LivroWSService {
    ...
    public br.com.caelum.livraria.webservice.LivroWS getLivroWSPort() throws javax.xml.rpc.ServiceException {
    ...
    public br.com.caelum.livraria.webservice.LivroWS getLivroWSPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.caelum.livraria.webservice.LivroWSServiceSoapBindingStub _stub = new br.com.caelum.livraria.webservice.LivroWSServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.caelum.livraria.webservice.LivroWS.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.caelum.livraria.webservice.LivroWSServiceSoapBindingStub _stub = new br.com.caelum.livraria.webservice.LivroWSServiceSoapBindingStub(new java.net.URL(LivroWSPort_address), this);
                _stub.setPortName(getLivroWSPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice.livraria.caelum.com.br/", "LivroWSService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice.livraria.caelum.com.br/", "LivroWSPort"));
        }
